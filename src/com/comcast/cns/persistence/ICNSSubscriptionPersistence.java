...
public interface ICNSSubscriptionPersistence {
  ...
  /**
   * Make a subscription request. Initially the subscription will be unconfirmed / inactive. CNS
   * will automatically send a confirmation request containing a token to the specified end point
   * using the desired protocol. It is the client's responsibility to parse out the token and call
   * confirmSubscritpion. If topic owner and subscription owner are the same no confirmation is
   * necessary and no request will be sent.
   *
  ...
  /**
   * List all subscriptions for a user including unconfirmed subscriptions. Pagination for more than
   * 100 subscriptions. Not part of official AWS API. Not part of official AWS API.
   *
   * @param nextToken
   * @param protocol optional filter by protocol (this parameter is not part of official AWS API)
   * @param userId
  ...
  /**
   * List all active subscriptions for a topic, unconfirmed subscriptions will not reveal their
   * arns. Pagination for more than 100 subscriptions.
   *
   * @param nextToken initially null, on subsequent calls arn of last result from prior call
   * @param topicArn topic arn
   * @param protocol optional filter by protocol (this parameter is not part of official AWS API)
  ...
  /**
   * List all active subscriptions for a topic, unconfirmed subscriptions will not reveal their
   * arns. Page size is configurable.
   *
   * @param nextToken initially null, on subsequent calls arn of last result from prior call
   * @param topicArn topic arn
   * @param protocol optional filter by protocol (this parameter is not part of official AWS API)
  ...
  /**
   * List all subscriptions for a topic including unconfirmed subscriptions. Pagination for more
   * than 100 subscriptions. Not part of official AWS API.
   *
   * @param nextToken initially null, on subsequent calls arn of last result from prior call
   * @param topicArn topic arn
   * @param protocol optional filter by protocol (this parameter is not part of official AWS API)
