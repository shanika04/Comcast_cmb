 ...
 *
 * @author bwolf, jorge Class is not thread-safe. Caller must ensure thread-safety
 */
public class CNSThrottlePolicy {
  ...
  public CNSThrottlePolicy(JSONObject json) throws CNSModelConstructionException {
    ...
    try {
      ...
      if (json.has("maxReceivesPerSecond")
          && (json.get("maxReceivesPerSecond") != JSONObject.NULL)) {
