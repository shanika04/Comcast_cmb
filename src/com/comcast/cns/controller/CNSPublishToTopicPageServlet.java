  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (parameters.containsKey("Publish")) {
      ...
      if (topicArn != null) {
        ...
        out.print(
            "<form action=\"/webui/cnsuser/publish?topicArn="
                + topicArn
                + "&userId="
                + userId
                + "\" "
                + "method=POST>");
        out.println(
            "<table><tr><td><b>Topic Name:</b></td><td>"
                + Util.getNameFromTopicArn(topicArn)
                + "</td></tr>");
        ...
        // out.println("<p><i><font color='grey'>For SMS notifications, it is best to leave the
        // Subject field blank and place your text in the Message field to send a maximum of 140
        // characters. If the Subject field is not blank, the text in the Subject field will be used
        // as content for the SMS messages.</font></i></p>");
