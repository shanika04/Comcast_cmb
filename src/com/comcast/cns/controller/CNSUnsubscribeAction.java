...
public class CNSUnsubscribeAction extends CNSAction {
  ...
  /**
   * The method simply gets the information from the user and request to call doUnsubscribe on the
  ...
  public boolean doAction(User user, AsyncContext asyncContext) throws Exception {
    ...
    if ((arn == null) || (userId == null)) {
      logger.error(
          "event=cns_unsubscribe error_code=InvalidParameters arn=" + arn + " user_id=" + userId);
