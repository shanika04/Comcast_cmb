    ...
    if (params.containsKey("Update")) {
      ...
      try {
        ...
        SetTopicAttributesRequest setTopicAttributesRequest =
            new SetTopicAttributesRequest(topicArn, "DeliveryPolicy", deliveryPolicy.toString());
      ...
      if (topicArn != null) {
        ...
        try {
          ...
          deliveryPolicy =
              new CNSTopicDeliveryPolicy(new JSONObject(attributes.get("DeliveryPolicy")));
        } catch (Exception ex) {
      ...
      out.println(
          "<form action=\"/webui/cnsuser/editdeliverypolicy?topicArn="
              + topicArn
              + "\" method=POST>");
      ...
      out.println(
          "<tr><td colspan=2><b>Apply these delivery policies for the topic:</b></td></tr>");
      out.println(
