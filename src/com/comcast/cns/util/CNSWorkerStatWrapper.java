...
public class CNSWorkerStatWrapper {
  ...
  private static AbstractDurablePersistence cassandraHandler =
  ...
  private static void callOperation(String operation, List<CNSWorkerStats> cnsWorkerStats)
      throws Exception {
    ...
    if ((operation != null)
        && (operation.equals("startWorker") || operation.equals("stopWorker"))) {
      ...
      for (CNSWorkerStats stats : cnsWorkerStats) {
        try {
          ...
          throw new CMBException(
              CMBErrorCodes.InternalError, "Cannot " + operationString + " CNS workers");
        } finally {
