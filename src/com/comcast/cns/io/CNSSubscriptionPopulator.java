...
public class CNSSubscriptionPopulator {
  ...
  public static String getListSubscriptionResponse(
      List<CNSSubscription> subscriptions, String nextToken) {
  ...
  public static String getListSubscriptionByTopicResponse(
      List<CNSSubscription> subscriptions, String nextToken) {
  ...
  public static String getConfirmSubscriptionResponse(CNSSubscription subscription) {
    ...
    out.append("\t\t<SubscriptionArn>")
        .append(subscription.getArn())
  ...
  public static String getPublishResponse(List<String> receiptHandles) {
    ...
    StringBuffer out =
        new StringBuffer("<PublishResponse xmlns=\"http://sns.amazonaws.com/doc/2010-03-31/\">\n");
