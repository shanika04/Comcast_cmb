...
public abstract class Action {
   ...
   * @throws Exception
   * @return true if this action was performed, false otherwise. It is largely dependent on the
   *     sub-classes to override this return value with what makes sense.
   */
   ...
   */
  public abstract boolean isActionAllowed(
   ...
   * @throws IOException
   */
  public static void writeResponse(String content, HttpServletResponse response)
      throws IOException {
