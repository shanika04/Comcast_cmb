...
/** @author michael, bwolf, baosen Interface representing functionality to authenticate users */
public interface IAuthModule {

  public void setUserPersistence(IUserPersistence userPersistence);

  /**
   * Authenticate the request by checking the signature provided in the parameters. Assumed that the
   * request has the following parameters: - AWSAccessKeyId - Signature - Timestamp - Expires -
  ...
  /**
   * Get the User by Request AWSAccessKeyId. Assumed that the request has the following parameters:
   * - AWSAccessKeyId
   *
   * @param request
   * @return user or null
