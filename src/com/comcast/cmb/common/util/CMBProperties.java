 ...
 *
 * @author jorge, vvenkatraman, michael, bwolf, aseem Class is thread-safe
 */
public class CMBProperties {
  ...
  public volatile int
      publishJobQueueSizeLimit; // this made public volatile so unit-tests can tweak it
  ...
  private CMBProperties() {
    ...
    try {
      ...
      cmbUseInlineApiCalls =
          Boolean.parseBoolean(props.getProperty("cmb.useInlineApiCalls", "true"));
      ...
      readConsistencyLevel =
          props.getProperty("cmb.cassandra.readConsistencyLevel", consistencyLevel);
      writeConsistencyLevel =
          props.getProperty("cmb.cassandra.writeConsistencyLevel", consistencyLevel);
      ...
      cnsBypassPublishJobQueueForSmallTopics =
          Boolean.parseBoolean(
              props.getProperty("cmb.cns.bypassPublishJobQueueForSmallTopics", "true"));
      ...
      cnsPublisherEnabled =
          Boolean.parseBoolean(props.getProperty("cmb.cns.publisherEnabled", "true"));
      ...
      maxMessagePayloadLogLength =
          Integer.parseInt(props.getProperty("cmb.log.maxMessagePayloadLogLength", "0"));
      ...
      cqsLongPollEnabled =
          Boolean.parseBoolean(props.getProperty("cmb.cqs.longpoll.enable", "true"));
      ...
      cnsPublishQueueNamePrefix =
          props.getProperty("cmb.cns.publish.queueNamePrefix", "PublishJobQ_");
      cnsEndpointPublishQueueNamePrefix =
          props.getProperty("cmb.cns.publish.endpointQueueNamePrefix", "EndpointPublishQ_");
      ...
      hectorAutoDiscoveryDelaySeconds =
          Integer.parseInt(props.getProperty("cmb.hector.autoDiscoveryDelaySeconds", "60"));
      hectorAutoDiscovery =
          Boolean.parseBoolean(props.getProperty("cmb.hector.autoDiscovery", "true"));
      hectorBalancingPolicy =
          props.getProperty("cmb.hector.balancingPolicy", "RoundRobinBalancingPolicy");

      if (props.getProperty("cmb.cassandra.username") != null
          && props.getProperty("cmb.cassandra.password") != null) {
      ...
      publisherThreadPoolSize =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.threadPoolSize", "20"));
      publishJobQueueSizeLimit =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.publishJobQueueSizeLimit", "100000"));
      pingDelayMS = Integer.parseInt(props.getProperty("cmb.cns.publisher.pingDelayMS", "60000"));
      workStealerDelayMS =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.workStealerDelayMS", "60000"));

      redisPubSubEndpointConnectionTimeoutMS =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.redisPubSub.connectionTimeoutMS", "3000"));
      enableSignatureAuth =
          Boolean.parseBoolean(props.getProperty("cmb.enableSignatureAuth", "false"));
      allowGetRequest = Boolean.parseBoolean(props.getProperty("cmb.allowGetRequest", "true"));
      requireSubscriptionConfirmation =
          Boolean.parseBoolean(
              props.getProperty("cmb.cns.requireSubscriptionConfirmation", "true"));
      ...
      msgRetentionPeriod =
          Integer.parseInt(props.getProperty("cmb.cqs.msgRetentionPeriod", "345600"));
      maxMsgRetentionPeriod =
          Integer.parseInt(props.getProperty("cmb.cqs.maxMsgRetentionPeriod", "1209600"));
      minMsgRetentionPeriod =
          Integer.parseInt(props.getProperty("cmb.cqs.minMsgRetentionPeriod", "60"));
      ...
      maxMessageSuppliedIdLength =
          Integer.parseInt(props.getProperty("cmb.cqs.maxMessageSuppliedIdLength", "80"));
      maxBatchEntries = Integer.parseInt(props.getProperty("cmb.cqs.maxBatchEntries", "10"));
      maxReceiveMessageCount =
          Integer.parseInt(props.getProperty("cmb.cqs.maxReceiveMessageCount", "10"));
      ...
      userCacheExpiring =
          Integer.parseInt(props.getProperty("cmb.user.cacheExpiringInSeconds", "60"));
      userCacheSizeLimit = Integer.parseInt(props.getProperty("cmb.user.cacheSizeLimit", "1000"));

      httpPublisherEndpointConnectionPoolSize =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.http.connectionPoolSize", "250"));
      httpPublisherEndpointConnectionsPerRouteSize =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.http.connectionsPerRouteSize", "50"));
      httpTimeoutSeconds =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.http.httpTimeoutSeconds", "5"));
      acceptableHttpStatusCodes =
          Arrays.asList(
              props.getProperty("cmb.cns.publisher.http.acceptableStatusCodes", "").split(","));
      cnsIOMode =
          IO_MODE.valueOf(props.getProperty("cmb.cns.publisher.http.iomode", "sync").toUpperCase());

      cnsCacheExpiring =
          Integer.parseInt(props.getProperty("cmb.cns.cacheExpiringInSeconds", "60"));
      cnsCacheSizeLimit = Integer.parseInt(props.getProperty("cmb.cns.cacheSizeLimit", "1000"));

      cqsCacheExpiring =
          Integer.parseInt(props.getProperty("cmb.cqs.cacheExpiringInSeconds", "60"));
      cqsCacheSizeLimit = Integer.parseInt(props.getProperty("cmb.cqs.cacheSizeLimit", "1000"));

      cqsNumberOfQueuePartitions =
          Integer.parseInt(props.getProperty("cmb.cqs.numberOfQueuePartitions", "100"));

      rollingWindowTimeSec = Integer.parseInt(props.getProperty("cmb.rollingWindowSizeSec", "600"));

      redisConnectionsMaxTotal =
          Integer.parseInt(props.getProperty("cmb.redis.connectionsMaxTotal", "100"));
      ...
      redisRevisibleThreads =
          Integer.parseInt(props.getProperty("cmb.redis.revisibleThreads", "3"));
      redisExpireTTLSec = Integer.parseInt(props.getProperty("cmb.redis.expireTTLSec", "1209600"));
      redisRevisibleFrequencySec =
          Integer.parseInt(props.getProperty("cmb.redis.revisibleFrequencySec", "10"));
      redisRevisibleSetFrequencySec =
          Integer.parseInt(props.getProperty("cmb.redis.revisibleSetFrequencySec", "1"));

      cassandraThriftSocketTimeOutMS =
          Integer.parseInt(props.getProperty("cmb.cassandra.thriftSocketTimeOutMS", "10000"));
      astyanaxMaxConnectionsPerNode =
          Integer.parseInt(props.getProperty("cmb.astyanax.maxConnectionsPerNode", "10"));
      astyanaxConnectionWaitTimeOutMS =
          Integer.parseInt(props.getProperty("cmb.astyanax.connectionWaitTimeOutMS", "2000"));

      numEPPubJobProducers =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.numProducers", "8"));
      numEPPubJobConsumers =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.numConsumers", "4"));
      numPublishJobQs =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.numPublishJobQs", "2"));
      numEPPublishJobQs =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.numEPPublishJobQs", "4"));
      numDeliveryHandlers =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.numDeliveryHandlers", "128"));
      numReDeliveryHandlers =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.numReDeliveryHandlers", "128"));
      deliveryHandlerJobQueueLimit =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.deliveryHandlerJobQueueLimit", "1000"));
      reDeliveryHandlerJobQueueLimit =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.reDeliveryHandlerJobQueueLimit", "5000"));
      publishJobVTO = Integer.parseInt(props.getProperty("cmb.cns.publisher.publishJobVTO", "30"));
      EPPublishJobVTO =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.EPPublishJobVTO", "30"));
      maxSubscriptionsPerEPPublishJob =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.maxSubscriptionsPerEPPublishJob", "100"));
      producerProcessingMaxDelay =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.producerProcessingMaxDelay", "1000"));
      consumerProcessingMaxDelay =
          Integer.parseInt(
              props.getProperty("cmb.cns.publisher.consumerProcessingMaxDelay", "1000"));

      endpointFailureCountToSuspensionThreshold =
          Integer.parseInt(
              props.getProperty(
                  "cmb.cns.publisher.endpointFailureCountToSuspensionThreshold", "10"));
      cnsMessageExpirationSeconds =
          Integer.parseInt(props.getProperty("cmb.cns.publisher.messageExpirationSeconds", "0"));
      ...
      log.error(
          "event=load_cmb_properties error_code=unable_to_load_file file=" + file.getAbsolutePath(),
          ex);
