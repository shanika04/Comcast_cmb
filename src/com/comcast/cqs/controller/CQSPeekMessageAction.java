...
public class CQSPeekMessageAction extends CQSAction {
  ...
  protected List<CQSMessage> getMessages(
      HttpServletRequest request, boolean useParams, CQSQueue queue)
      throws PersistenceException, CMBException, IOException, NoSuchAlgorithmException,
