  ...
  public boolean doAction(User user, AsyncContext asyncContext) throws Exception {
    ...
    while (suppliedId != null && receiptHandle != null) {
      ...
      if (idList.contains(suppliedId)) {
        throw new CMBException(
            CQSErrorCodes.BatchEntryIdsNotDistinct,
    ...
    for (Map.Entry<String, String> entry : idMap.entrySet()) {
      ...
      PersistenceFactory.getCQSMessagePersistence()
          .deleteMessage(queue.getRelativeUrl(), receiptHandle);
    }

    String out =
        CQSMessagePopulator.getDeleteMessageBatchResponse(
            new ArrayList<String>(idMap.keySet()), failedList);
