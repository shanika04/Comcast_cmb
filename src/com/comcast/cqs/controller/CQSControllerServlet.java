...
public class CQSControllerServlet extends CMBControllerServlet {
  ...
  private void initActions() {
    ...
    final CQSChangeMessageVisibilityAction changeMessageVisibilityAction =
        new CQSChangeMessageVisibilityAction();
    ...
    final CQSChangeMessageVisibilityBatchAction changeMessageVisibilityBatchAction =
        new CQSChangeMessageVisibilityBatchAction();
  ...
  protected boolean handleAction(String action, User user, AsyncContext asyncContext)
    ...
    if (!action.equals("CreateQueue")
        && !action.equals("healthCheckShallow")
        && !action.equals("HealthCheck")
        && !action.equals("ManageService")
        && !action.equals("GetQueueUrl")
        && !action.equals("ListQueues")
