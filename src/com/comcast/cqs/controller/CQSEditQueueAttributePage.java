  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (params.containsKey("Update")) {
      ...
      try {
        ...
        logger.error(
            "event=set_queue_attributes queue_ulr=" + queueUrl + " user_id= " + userId, ex);
      ...
      out.println(
          "<form action=\"/webui/cqsuser/editqueueattributes?queueName="
              + queueName
              + "\" method=POST>");
      out.println("<input type='hidden' name='userId' value='" + userId + "'>");
      out.println("<table>");
      out.println(
          "<tr><td colspan=2><b><font color='orange'>Queue Attributes</font></b></td></tr>");
      ...
      out.println(
          "<tr><td>Visibility Timeout:</td><td><input type='text' name='visibilityTimeout' size='50' value='"
              ...
              + "'></td></tr>");
      out.println(
          "<tr><td>&nbsp;</td><td><I><font color='grey'>Default "
              + CMBProperties.getInstance().getCQSVisibilityTimeOut()
              + " sec</font></I></td></tr>");
      ...
      out.println(
          "<tr><td>&nbsp;</td><td><I><font color='grey'>Default "
              + CMBProperties.getInstance().getCQSMessageRetentionPeriod()
              + " sec</font></I></td></tr>");

      out.println(
          "<tr><td>Delay Seconds:</td><td><input type='text' name='delaySeconds' size='50' value='"
              + delaySeconds
              + "'></td></tr>");
      out.println(
          "<tr><td>&nbsp;</td><td><I><font color='grey'>Default "
              + CMBProperties.getInstance().getCQSMessageDelaySeconds()
              + " sec</font></I></td></tr>");
      ...
      out.println(
          "<tr><td>Compressed:</td><td><input type='text' name='isCompressed' size='50' value='"
              + isCompressed
              + "'></td></tr>");
      out.println(
