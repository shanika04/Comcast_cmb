...
public final class CQSMessage implements Serializable {
  ...
  private transient String mD5OfBody;

  private transient String md5OfMessageAttributes;

  private String body;

  private transient Map<String, String> attributes;

  private transient Map<String, CQSMessageAttribute> messageAttributes;

  private transient String suppliedMessageId;
  ...
  public CQSMessage(String messageId, String body)
      throws NoSuchAlgorithmException, UnsupportedEncodingException {
  ...
  public CQSMessage(Message message) {
    ...
    for (String messageAttributeName : message.getMessageAttributes().keySet()) {
      MessageAttributeValue messageAttributeValue =
          message.getMessageAttributes().get(messageAttributeName);
      CQSMessageAttribute ma =
  ...
  private String getMD5(Map<String, CQSMessageAttribute> messageAttributes)
      throws NoSuchAlgorithmException, UnsupportedEncodingException {
  ...
  private void setLengthBytes(MessageDigest digest, String str)
  ...
  /**
   * The persistent state of the CQSMessage Note: Object returned does not have the messageId or the
   * receiptHandle set. caller must set it
   *
   * @param aInputStream
